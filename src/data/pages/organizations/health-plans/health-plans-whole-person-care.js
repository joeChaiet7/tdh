const metaData = {
  title: "Virtual Whole Person Care Solutions for Health Plans",
  description: "Teladoc Health offers members an always-on, unified consumer experience across primary care, chronic care, and mental healthcare."
}

const pageData = {
  propelId: "PL015965",
  disclaimer: "*Teladoc Health survey of over 2,200 consumers, 2021"
}
...
const heroData = {
  ...
  text_position: "start",
  image: {
    url: "https://s3.amazonaws.com/images.teladoc.com/teladoc-health-next/pages/organizations/health-plans/wpc/hp_wpc_hero.jpg",
    alt: ""
  },
  theme: "dark",
  cta: [
  ...
  items: [
    {
      id: 0,
      icon: "check cloud",
      title: "Positive member experience",
    ...
    },
    {
      ...
      description: "Reduce the need to manage multiple virtual care programs with a scalable platform that fits your ecosystem."
    },
    {
      id: 2,
      icon: "check list",
