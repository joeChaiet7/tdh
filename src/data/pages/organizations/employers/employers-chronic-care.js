...
const heroData = {
  type: "circle",
  title: "Chronic care for employers",
  subtitle: "Multi-condition solutions deliver guaranteed value for employees living with diabetes, hypertension or other conditions.",
  text_position: "start",
  image: {
    url: "https://s3.amazonaws.com/images.teladoc.com/teladoc-health-next/pages/organizations/employers/ccm/emp_ccm_hero.jpg",
    alt: "Woman smiling while dancing on the beach"
  },
  theme: "dark",
  cta: [
    {
...
const gridData = {
  ...
  items: [
    ...
    {
      id: 2,
      title: "Differentiated benefits",
      description: "Attract and retain talent with programs that include connected devices, clinician oversight and convenient home delivery programs",
      image: {
    ...
    },
    {
      ...
      image: {
        url: "https://s3.amazonaws.com/images.teladoc.com/teladoc-health-next/pages/organizations/employers/ccm/emp_ccm_innovation.png",
...
const resourcesData = {
  ...
  items: [
    ...
    },
    {
      ...
      type: "article",
      image: {
        url: "https://s3.amazonaws.com/images.teladoc.com/teladoc-health-next/pages/organizations/employers/ccm/emp_ccm_diabetes.jpg",
