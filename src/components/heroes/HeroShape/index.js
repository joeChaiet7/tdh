...
/**
 * HeroShape
 * Hero component with an image in a pill shape with pavers.
...
import * as styles from './heroShape.module.scss'
...
export default function HeroShape(props) {
  ...
  return (
    <>       
      <section className={`${styles.heroShape} ${styles[text_position]} ${styles[theme]}`}>
          ...
          {image && 
            <div className={styles.image}>
              <div className={styles.shape}>
                ...
                <div className={styles.shapeHalf} />
              </div>
            </div>
          }  
