...
import * as styles from './accordionSegment.module.scss';

export default function AccordionSegment(props) {
  ...
  return (
    <section className={styles.accordionSegment}>
          ...
          { (activeItem && activeItem.image) && 
            <div className={`${styles.itemImage}`}>
              <img 
                ...
                alt={activeItem.image.alt ? activeItem.image.alt : "Why trust Teladoc Health?"}
              />
            </div>
          }
